      ...
      <div className="flex flex-col items-center gap-6 md:flex-row md:items-end md:gap-8">
        ...
        <div className="relative h-64 w-64 shrink-0 rounded-2xl md:h-80 md:w-80 lg:h-96 lg:w-96">
          ...
          <img
            ...
            className={`h-full w-full rounded-2xl object-cover ring-1 ring-white/[0.10] transition-opacity duration-700 backdrop-blur-md shadow-[inset_0_4px_0_0_rgba(255,255,255,0.06),0_8px_16px_-4px_rgba(0,0,0,0.25)] ${
        ...
        >
          <span className="font-stalemate text-5xl tracking-wide text-white/50 transition-all duration-500 group-hover:text-[#E6E6E6] active:text-[#EBEBEB] md:text-6xl lg:text-7xl inline-block">
            Chandan.
          </span>
