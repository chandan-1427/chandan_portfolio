...
export default function LinkButton({ href, variant = "code", children, className = "" }) {
  const variants = {
    ...
    code: "bg-white/[0.04] text-white/70 border-white/[0.08] shadow-[inset_0_0px_0_0_rgba(255,255,255,0.06),0_4px_8px_-2px_rgba(0,0,0,0.2)] hover:bg-white/[0.07] hover:text-white/70 hover:border-white/[0.12] active:bg-white/[0.03] active:shadow-none",
  };
